...
//! format: canonical-CBOR envelope, argon2id + XChaCha20-Poly1305.
...
fn build_fixture() -> Fixture {
    ...
    Fixture {
        comment: "Cross-platform wallet-file vectors. Generated by \
            rrn-identity/tests/cross_platform_wallet.rs (rrn_identity::wallet is \
            the source of truth). Mobile reaches the same .rrnwallet \
