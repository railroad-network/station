...
//! on the `rrn1…` address for any given public key, byte-for-byte.
//!
...
fn build_fixture() -> Fixture {
    ...
    Fixture {
        comment: "Cross-platform address vectors. Generated by \
...
fn committed_fixture_is_in_sync() {
    ...
    assert_eq!(
        ...
        "fixture drift — regenerate with RRN_REGEN=1 cargo test -p rrn-identity \
         --test it cross_platform_address, then copy the JSON into the mobile repo"
    );
}
