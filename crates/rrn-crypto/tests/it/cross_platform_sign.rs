...
//! agree on which signatures verify.
//!
...
fn build_fixture() -> Fixture {
    ...
    Fixture {
        comment: "Cross-platform signing vectors. Generated by \
...
fn committed_fixture_is_in_sync() {
    ...
    assert_eq!(
        ...
        "fixture drift — regenerate with RRN_REGEN=1 cargo test -p rrn-crypto \
         --test it cross_platform_sign, then copy the JSON into the mobile repo"
    );
}
