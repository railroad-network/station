...
//!   RRN_REGEN=1 cargo test -p rrn-station --test it cross_platform_pairing
...
fn build_fixture() -> Fixture {
    ...
    Fixture {
        comment: "Cross-platform pairing vectors. Generated by \
...
fn committed_fixture_is_in_sync() {
    ...
    assert_eq!(
        ...
        "fixture drift — regenerate with RRN_REGEN=1 cargo test -p rrn-station \
         --test it cross_platform_pairing, then copy the JSON into the mobile repo"
    );
}
