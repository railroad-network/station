//! Cross-platform `SignedVouch` vectors.
//!
...
//!   RRN_REGEN=1 cargo test -p rrn-station --test it cross_platform_vouch
...
fn build_fixture() -> Fixture {
    Fixture {
        comment: "Cross-platform SignedVouch vectors. Generated by \
...
fn committed_fixture_is_in_sync() {
    ...
    assert_eq!(
        ...
        "fixture drift — regenerate with RRN_REGEN=1 cargo test -p rrn-station \
         --test it cross_platform_vouch, then copy the JSON into the mobile repo"
    );
}
