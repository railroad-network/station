//! Cross-platform inquiry-record vectors.
//!
...
//!   RRN_REGEN=1 cargo test -p rrn-station --test it cross_platform_inquiry
...
fn build_fixture() -> Fixture {
    Fixture {
        comment: "Cross-platform inquiry-record vectors. Generated by \
...
fn committed_fixture_is_in_sync() {
    ...
    assert_eq!(
        ...
        "fixture drift — regenerate with RRN_REGEN=1 cargo test -p rrn-station \
         --test it cross_platform_inquiry, then copy the JSON into the mobile repo"
    );
}
