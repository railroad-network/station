...
//! module is gated `#[cfg(target_os = "linux")]` (on its declaration in `tests/it/main.rs`)
//! and every test is `#[ignore]`d:
...
//! cargo test -p rrn-station --test it -- --ignored --nocapture at_rest_dmcrypt::
//! ```
