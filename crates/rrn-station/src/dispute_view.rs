...
//! [`rrn_ledger`], and the sortition jury in [`rrn_dispute`] — was built, but
//! exposed none of it to a reader. This module is that read path: it turns the log-derived dispute
