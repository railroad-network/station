...
Accepted — ratified 2026-09-07 (the maintainer delegated the decision review,
which returned accept with caveats, and then confirmed the outcome; the caveats
are folded in:
